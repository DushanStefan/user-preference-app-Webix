        ...
        { gravity: 1 },
        {
          ...
          elements: [
            ...
            },
            {
              ...
              css: "otp-description",
              template:
                "<div class='otp-text'>Please check your email to see the verification code.</div>",
              height: 50,
              borderless: true,
            },
            {
                  ...
                  on: {
                    ...
                    onKeyUp: function (code, e) {
                      if (code === 39 || code === 13) {
                        ...
                        // Left arrow key
                        $$("otp1").focus();
                      } else if (code === 8 && e.target.value === "") {
                        // Backspace key and field is empty
            ...
            },
            {
              ...
              click: function () {
                ...
                if (otp.length === 4 && /^\d{4}$/.test(otp)) {
                  ...
                  webix.message({
                    type: "error",
                    text: "Invalid OTP. Please enter a 4-digit code.",
                  });
                }
              },
            },
